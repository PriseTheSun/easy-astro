    ...
    <section className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className="group relative bg-gray-900 rounded-3xl p-8 border border-gray-800 hover:border-gray-700 transition-colors overflow-hidden"
            >
        ...
        <motion.div
          ...
          className="bg-gray-900 rounded-3xl p-8 lg:p-12 border border-gray-800"
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-white mb-6">Recursos Incluídos</h3>
              ...
              <div className="relative bg-gray-800 rounded-3xl p-8">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <div className="text-gray-400 text-sm">Aumento de produtividade</div>
                  </div>
                ...
                <div className="mt-6 flex items-center justify-between text-sm">
                  <span className="text-gray-400">Tempo economizado</span>
