    ...
    <div className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-[10px] text-gray-400">{number}</div>
        </div>
      </div>
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto">
        ...
        <div className="p-3 bg-gray-50">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div className="bg-white rounded-xl p-3 border border-gray-100">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-semibold text-gray-900 text-xs">Processos Recentes</h4>
            ...
            <div className="bg-white rounded-xl p-3 border border-gray-100">
              <div className="flex items-center justify-between mb-2">
                <h4 className="font-semibold text-gray-900 text-xs">Próximos Prazos</h4>
                <ChevronDown className="w-3 h-3 text-gray-400" strokeWidth={1.5} />
              </div>
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 py-1.5 border-b border-gray-100 last:border-0">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-[10px] text-gray-400">{item.court}</div>
                    </div>
          ...
          <div className="mt-3 grid grid-cols-3 gap-2">
            ...
            <div className="bg-white rounded-xl p-3 border border-gray-100">
              <div className="flex items-center gap-1.5 mb-1">
                <Shield className="w-3 h-3 text-green-600" strokeWidth={1.5} />
                <span className="text-[10px] font-medium text-gray-700">Segurança</span>
              </div>
            ...
            <div className="bg-white rounded-xl p-3 border border-gray-100">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[10px] font-medium text-gray-700">Performance</span>
              </div>
              <div className="text-lg font-bold text-gray-900">+85%</div>
              <div className="text-[10px] text-gray-400">Produtividade</div>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute -right-3 bottom-1/3 w-14 h-14 bg-white rounded-xl shadow-xl p-2 flex items-center justify-center border-2 border-gray-100"
      >
